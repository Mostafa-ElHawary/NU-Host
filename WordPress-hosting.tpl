...
<section class="padding-100-0">
	...
	<div class="wp-plan-features-text">free introduction<br> & setup</div>
	</div>
	...
	<div class="container">
	<div class="tittle-simple-one"><h5>The Easiest WordPress Transfer!<span> is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book<br> typesetting industry.</span></h5></div><!-- title -->
	...
	<section style="position: relative;margin-bottom: -20px;" class="padding-90-0-100 position-relative overflow-hidden">
